...
namespace ReModCE_ARES.Components
{
    ...
    internal class AntiAvatarCrashComponent : ModComponent
    {
        ...
        public override void OnUiManagerInit(UiManager uiManager)
        {
            ...
            WhitelistByID = mainmenu.AddButton("Whitelist By ID", "Whitelist an avatar by the Avatar ID", () =>
            {
                PopupTextInput(WhitelistByID, false);
            });

            BlacklistByID = mainmenu.AddButton("Blacklist By ID", "Blacklists an avatar by the Avatar ID", () =>
            {
